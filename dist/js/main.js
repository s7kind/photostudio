...
/*gallery*/
if (gallery !== null) {
    __webpack_require__(/*! ./modules/functions/gallery */ "./src/js/modules/functions/gallery.js")(gallery);
}

/*category*/
if (category !== null) {
    __webpack_require__(/*! ./modules/functions/category */ "./src/js/modules/functions/category.js")(category);
}

/*img scroll*/
if (services !== null) {
    __webpack_require__(/*! ./modules/functions/imgScroll */ "./src/js/modules/functions/imgScroll.js")(services);
    __webpack_require__(/*! ./modules/functions/services */ "./src/js/modules/functions/services.js")(services);
}

/*video box height*/
if (videoBox !== null) {
    __webpack_require__(/*! ./modules/functions/video */ "./src/js/modules/functions/video.js")();
}

/*animation*/
if (animationLoad.length > 0) {
    __webpack_require__(/*! ./modules/functions/animation */ "./src/js/modules/functions/animation.js")(animationLoad);
}
...
/***/ "./src/js/modules/functions/animation.js":
/*!***********************************************!*\
  !*** ./src/js/modules/functions/animation.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/functions/category.js":
/*!**********************************************!*\
  !*** ./src/js/modules/functions/category.js ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = (wrap) => {
    ...
    /*const categoryArr = wrap.querySelectorAll('.category-wrap__item');
    let img, imgArr;

    for (let i = 0; i < categoryArr.length; i++) {
        categoryArr[i].addEventListener('mouseover', function (event) {
            removeActive(categoryArr);
            event.currentTarget.classList.add('active');
            img = categoryArr[i].querySelector('img');
            img.style.width = `100%`;
        });
    }
    ...
    function removeActive(arr) {
        for (let i = 0; i < arr.length; i++) {
            arr[i].classList.remove('active');
            imgArr = arr[i].querySelector('img');
            imgArr.style.width = `33%`;
        }
    }*/
...
/***/ "./src/js/modules/functions/gallery.js":
/*!*********************************************!*\
  !*** ./src/js/modules/functions/gallery.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/functions/imgScroll.js":
/*!***********************************************!*\
  !*** ./src/js/modules/functions/imgScroll.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/functions/services.js":
/*!**********************************************!*\
  !*** ./src/js/modules/functions/services.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/functions/video.js":
/*!*******************************************!*\
  !*** ./src/js/modules/functions/video.js ***!
  \*******************************************/
/*! no static exports found */
